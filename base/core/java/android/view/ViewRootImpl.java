...
public final class ViewRootImpl extends Handler implements ViewParentEink, ViewParent,
    ...
    public int drainDisplayQueue(View child) {
    ...
    void invalidate() {
        ...
        mDirtygroup.clear();
        mDirtygroup.add(new int []{0, 0, mWidth, mHeight, View.UI_DEFAULT_MODE});
        scheduleTraversals();
    }
    ...
    void invalidate(int updateMode) {
        mDirty.set(0, 0, mWidth, mHeight);
        mDirtygroup.clear();
        mDirtygroup.add(new int []{0, 0, mWidth, mHeight, updateMode});
        scheduleTraversals();
    }
    ...
    private void draw(boolean fullRedrawNeeded) {
        ...
        if (mAttachInfo.mHardwareRenderer != null && mAttachInfo.mHardwareRenderer.isEnabled()) {
            if (!dirty.isEmpty() || mIsAnimating) {
                ...
                surface.setDirtyRectGroup(dirtyGroup);
                mDirtygroup.clear();
