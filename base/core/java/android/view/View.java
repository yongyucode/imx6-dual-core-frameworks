...
public class View implements Drawable.Callback, Drawable.Callback2, KeyEvent.Callback,
    ...
    */
    ...
    /**
     * The waveform mode of animation
     * data
     * @hide
     */
     ...
     *
     * The dithering processing will be done to enhance the
     * gray-tone of graphics. The target color depth is selected
     * in dither_color ( Y4 or Y1 ). Since auto waveform is selected
     * before dithering, the dithering flag will not affect the result
     * of auto waveform selection.
     * @hide
     */
    ...
    /**
     * Dithering for Y4 is selected
     *
     * Y8->Y4 dithering process will be selected.
     * @hide
     */
    public static final int EINK_DITHER_COLOR_Y4 = 0x00000000;

    /**
     * Dithering for Y1 is selected
     *
     * Y8->Y1 dithering process will be selected.
     * @hide
     */
    public static final int EINK_DITHER_COLOR_Y1 = 0x00000800;

    /**
     * The Mask of dithering color
     * @hide
     */
    public static final int EINK_DITHER_COLOR_MASK = 0x00000800;
    ...
    /** @hide */
    public int drainDisplayQueue() {
        final ViewParentEink p = (ViewParentEink)mParent;
        return p.drainDisplayQueue(this);
    }
        ...
        if ((mPrivateFlags & (DRAWN | HAS_BOUNDS)) == (DRAWN | HAS_BOUNDS) ||
            ...
            if (!HardwareRenderer.RENDER_DIRTY_REGIONS) {
                if (p != null && ai != null && ai.mHardwareAccelerated) {
                    // fast-track for GL-enabled applications; just invalidate the whole hierarchy
                    // with a null dirty rect, which tells the ViewAncestor to redraw everything
                    p.invalidateChild(this, null, updateMode);
                    return;
                }
            }
            if (p != null && ai != null && l < r && t < b) {
    ...
    /** @hide */
    void invalidate(boolean invalidateCache, int updateMode) {
        if (ViewDebug.TRACE_HIERARCHY) {
            ViewDebug.trace(this, ViewDebug.HierarchyTraceType.INVALIDATE);
        }
    ...
    /** @hide */
    public void fastInvalidate(int updateMode) {
        if (skipInvalidate()) {
            return;
        }
        if ((mPrivateFlags & (DRAWN | HAS_BOUNDS)) == (DRAWN | HAS_BOUNDS) ||
    ...
    public void postInvalidate(int updateMode) {
        postInvalidateDelayed(updateMode);
    }
    ...
    public void postInvalidateDelayed(long delayMilliseconds) {
        ...
        if (attachInfo != null && info != null) {
			info.updateMode = View.UI_DEFAULT_MODE;
			info.target = this;
