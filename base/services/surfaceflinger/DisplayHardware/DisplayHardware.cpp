...
#ifdef FSL_IMX_DISPLAY
void DisplayHardware::flip(const Region& dirty, int secRotation, Vector<Rect>& rectList, Vector<int>& modelist, int count) const
{
    mNativeWindow->setSecRotation(secRotation);
    flip(dirty, rectList, modelist, count);
}
#endif
#else
